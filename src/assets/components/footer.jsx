const Footer = () => {
  return (
    <footer className='bottom-0 text-center flex flex-col md:flex-row h-20 mb-0 justify-between items-center px-6 md:px-10 py-4 w-full border-t border-[#333333]'>
      ...
      <a href="github.com/agilzulfa16"><li>Github</li></a>
        <a href="linkedin.com/agilzulfa"><li className="opacity-50">LinkedIn</li></a>
        <a href="instagram.com/agilzulfa_"><li className="opacity-50">Instagram</li></a>
      </ul>
