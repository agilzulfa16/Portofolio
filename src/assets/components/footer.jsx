const Footer = () => {
  return (
    <footer className='bottom-0 text-center flex flex-col md:flex-row h-20 mb-0 justify-between items-center h-6 px-6 md:px-10 py-4 w-full border-t border-[#333333]'>
