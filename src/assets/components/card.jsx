  ...
  return (
    <motion.Card
     whileHover={{ scale: 1.02 }}
      shadow={false}
      className="relative grid h-[28rem]  w-full border-black border-2 shadow-xl shadow-black md:max-w-[20rem] w-[20rem] items-center justify-center overflow-hidden text-center  rounded-xl"
    >
      <CardHeader
        floated={false}
        shadow={false}
