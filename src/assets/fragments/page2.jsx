  ...
  return (
    <>
      <div className="bg-[#222222] w-screen min-h-screen text-white">
        <div className=" bg-[#252525] py-16 border-y-2  border-[#333333] mb-6">
            ...
            <div className="w-screen-lg px-8">
              <div className="flex md:space-x-20 space-x-0 md:flex-row flex-col md:text-start text-justify">
                <div className="space-y-8 md:w-6/12 w-full leading-8">
                  ...
                  <div className="flex space-x-8 md:flex-row flex-col items-center">
                  ...
                  <div className="flex space-x-8 md:flex-row flex-col items-center">
                    <img className="w-[62px] h-[59px]" src="react.svg" />
                    <div>
                      <h3 className="text-xl font-semibold text-center md:text-start">
                        React JS
                      </h3>
